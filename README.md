...
Исходный код сервиса авторизации лежит в папке __internal__. Код для запуска в папке __cmd__. В __Makefile__ написаны команды для сборки и запуска, а так же для запуска *unit-тестов*.<br/>
